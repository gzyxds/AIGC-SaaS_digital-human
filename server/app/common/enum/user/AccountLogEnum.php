...
class AccountLogEnum
{
    ...
    const UM_DEC_ORDER_AVATAR = 102;
    const UM_DEC_ORDER_VOICE = 103;
    const UM_DEC_ORDER_CLONE = 104;
    ...
    const UM_INC_REGISTER = 202;
    const UM_INC_ORDER_VOICE_BACK = 203;
    const UM_INC_ORDER_AVATAR_BACK = 204;
    const UM_INC_ORDER_CLONE_BACK = 205;
    ...
    const UM_DEC = [
        ...
        self::UM_DEC_ORDER_AVATAR,
        self::UM_DEC_ORDER_VOICE,
        self::UM_DEC_ORDER_CLONE,
    ];
    ...
    const UM_INC = [
        ...
        self::UM_INC_ORDER_VOICE_BACK,
        self::UM_INC_ORDER_AVATAR_BACK,
        self::UM_INC_ORDER_CLONE_BACK,
    ];
    ...
    public static function getChangeTypeDesc($changeType, $flag = false)
    {
        $desc = [
            ...
            self::UM_INC_REGISTER          => '用户注册赠送',
            self::UM_DEC_ORDER_AVATAR      => '数字人订单扣除',
            self::UM_DEC_ORDER_VOICE       => '声音合成订单扣除',
            self::UM_DEC_ORDER_CLONE       => '音色克隆订单扣除',
            self::UM_INC_ORDER_VOICE_BACK  => '声音克隆订单返还',
            self::UM_INC_ORDER_AVATAR_BACK => '数字人订单返还',
            self::UM_INC_ORDER_CLONE_BACK  => '克隆订单返还',
        ];
        if ($flag) {
            return $desc;
        }
