...
class SensitiveSettingLogic extends BaseLogic
{
     ...
     * @return void
     * @author yfdong
     * @date 2024/11/20 00:21
     */
    public static function setSensitiveSetting($params)
    {
        ConfigService::set('sensitive', 'sensitive_mode', $params['sensitive_mode']);
        ConfigService::set('tenant', 'sensitive_switch', $params['sensitive_switch']);
    }
