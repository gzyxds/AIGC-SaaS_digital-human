...
class PcLogic extends BaseLogic
{
    ...
    /**
     * @notes 装修配置
     * @return DecoratePage|array|mixed|\think\Model
     * @author JXDN
    ...
    public static function getConfigData()
    {
        ...
        $loginConfig = [
            ...
            // 注册方式
            'register_way'      => ConfigService::get('login', 'register_way', config('project.login.register_way')),
            // 注册强制绑定手机
        ...
        // 站点统计
        $unit = [
            'power' => ConfigService::get('marketing', 'unit', '算力'),
        ];
