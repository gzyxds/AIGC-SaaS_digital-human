import { StatusEnum, TaskStatusEnum, type UploadFileTypeEnum } from '~/enums/variableEnum';
 ...
 * @returns 是否成功
 */
export const isTaskSuccess = (status: TaskStatusEnum | taskStatusType | undefined) => {
 ...
 * @returns 是否进行中
 */
export const isTaskPendding = (status: TaskStatusEnum | taskStatusType | undefined) => {
 ...
 * @returns 是否失效
 */
export const isTaskInvalid = (status: TaskStatusEnum | taskStatusType | undefined) => {
    return status === null;
};
 ...
 * @returns 是否失败
 */
export const isTaskFail = (status: TaskStatusEnum | taskStatusType | undefined) => {
