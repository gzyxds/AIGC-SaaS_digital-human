    ...
    >
        <div class="pr-8">
            <el-form ref="formRef" :model="formData" label-width="120px" :rules="formRules">
                <el-form-item label="当前算力">{{ value }} </el-form-item>
                <el-form-item label="算力增减" required prop="action">
                    <el-radio-group v-model="formData.action">
                        <el-radio :value="1">增加算力</el-radio>
                        <el-radio :value="2">扣减算力</el-radio>
                    </el-radio-group>
                </el-form-item>
                <el-form-item label="调整算力" prop="num">
                    <el-input
                ...
                <el-form-item label="调整后算力"> {{ adjustmentMoney }} </el-form-item>
