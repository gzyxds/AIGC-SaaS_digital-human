    ...
    <div>
        ...
        >
            <el-card class="!border-none mt-4" shadow="never">
                ...
                <el-form-item label="小程序分享图标" prop="share_image">
                    <div>
                        <div>
                            <material-picker v-model="formData.share_image" :limit="1" />
                        </div>
                        <div class="form-tips">建议上传比例为5:4的.jpg或.png格式的图片</div>
                    </div>
                </el-form-item>
            </el-card>
            <el-card class="!border-none mt-4" shadow="never">
            ...
            <el-card class="!border-none mt-4" shadow="never">
                    ...
                    <div class="flex-1 min-w-0">
                        <div class="sm:flex">
                            <div class="mr-4 sm:w-80 flex">
                                <el-input :value="`https://${hostDomain}`" disabled />
                            </div>
                            <el-button v-copy="`https://${hostDomain}`">复制</el-button>
                        </div>
                        <div class="form-tips">
                ...
                <el-form-item label="socket合法域名">
                    <div class="flex-1 min-w-0">
                        <div class="sm:flex">
                            <div class="mr-4 sm:w-80 flex">
                                <el-input :value="`wss://${hostDomain}`" disabled />
                            </div>
                            <el-button v-copy="`wss://${hostDomain}`">复制</el-button>
                        </div>
                        <div class="form-tips">
                ...
                <el-form-item label="udp合法域名">
                    <div class="flex-1 min-w-0">
                        <div class="sm:flex">
                            <div class="mr-4 sm:w-80 flex">
                                <el-input :value="`udp://${hostDomain}`" disabled />
                            </div>
                            <el-button v-copy="`udp://${hostDomain}`">复制</el-button>
                        </div>
                        <div class="form-tips">
